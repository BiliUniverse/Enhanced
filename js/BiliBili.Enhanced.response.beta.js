...
*/
const $ = new Env("📺 BiliBili: ⚙️ Enhanced v0.2.2(2) response.beta");
const URL = new URLs();
const DataBase = {
	"Enhanced":{
		"Settings":{
			...
			"Mine":{"CreatorCenter":[],"Recommend":["400_794","402","403","404_791","789","790","2542"],"More":["407","410_798","1028","797"]},
