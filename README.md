...
使用设置页面前，安装或更新 [PreferencePanes 独立模块](https://github.com/Biliverse/Biliverse.github.io/tree/main/settings#安装)。0.7.0 的模块页由 github.io 调用 `build(BoxJS JSON)` 生成，独立模块只提供 Enhanced 模块页与对应 API，不接管 `/configs/` 或项目主页。Enhanced 的配置资源使用 `v=0.7.0` 更新缓存。
